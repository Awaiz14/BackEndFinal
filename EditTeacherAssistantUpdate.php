 ...
 <html lang="en"> <!-- indicates start of HTML document and the language of it (english) -->
    ...
    <body>
      ...
      <?php
        ...
        //MY OWN CODE
        //Retrieve the assistantID from the URL parameter
        $assistantID = $_GET['id'];
        ...
        // Retrieve the existing record from teacherassistants table
      ...
      <H1> Edit teacher assistant!</H1>
      <form action="EditTeacherAssistantUpdateSubmit.php" method="POST"> <!-- Creates a HTML form and links to php -->
