  ...
  <html lang="en"> <!-- indicates start of HTML document and the language of it (english) -->
    ...
    <body>
      ...
      <?php
        ...
        // Get form data from ViewAttendanceHTML.php
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table border='1'>
                    ...
                    </tr>"; // Creates a table which shows all this info from attendance table

            while ($row = $result->fetch_assoc()) { //Retrieves all the date and puts in the table to view
                echo "<tr>";
