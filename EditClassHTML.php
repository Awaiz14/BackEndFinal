    ...
    <body>
      ...
      <table> <!-- Creates table on webpage -->
        ...
        <?php
          ...
          // Retrieve information from the classes table in school database
          ...
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<td> <button><a href='EditClassUpdate.php?id=".$row['className']."'>Update</a></button> </td>"; //Adds update button to allow editing
              echo "</tr>";
          }
